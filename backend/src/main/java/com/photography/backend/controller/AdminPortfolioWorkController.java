...
public class AdminPortfolioWorkController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponseDTO<List<PortfolioWorkResponseDTO>>> getAllWorks() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponseDTO<PortfolioWorkResponseDTO>> getWorkById(@PathVariable Long id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponseDTO<Void>> deleteWork(@PathVariable Long id) {
